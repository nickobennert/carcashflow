...
function SortableRouteItem({
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "flex items-center gap-3 rounded-lg p-2 -ml-2",
...
export function EditRideForm({ ride }: EditRideFormProps) {
  ...
  function addStop() {
    update(fields.length - 1, { ...fields[fields.length - 1], order: fields.length })
        ...
        <div className="space-y-4">
          ...
          >
            <div className="relative pl-2">
              {fields.length > 1 && (
                <div
                  className="absolute left-[29px] top-4 w-0.5 bg-border"
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-between">
          ...
          <div className="flex gap-3">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className={routeType === "offer" ? "bg-offer hover:bg-offer/90" : "bg-request hover:bg-request/90"}
            >
